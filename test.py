...
def main():
    ...
    parser.add_argument('--data_name', default='PV', type=str)
    ...
    #  checkpoints dir
    args.checkpoint_dir = os.path.join('./checkpoints_pv', args.project_name)
    os.makedirs(args.checkpoint_dir, exist_ok=True)
    #  visualize dir
    args.vis_dir = os.path.join('work_dirs/SNUNet_pre', args.project_name)
